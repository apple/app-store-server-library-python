...
class TransactionHistoryRequest(Model):
    ...
    productIds: Optional[List[str]] = Field(default=None)
    """
    ...
    productTypes: Optional[List[ProductType]] = Field(default=None)
    """
    ...
    sort: Optional[Order] = Field(default=None)
    """
    ...
    subscriptionGroupIdentifiers: Optional[List[str]] = Field(default=None)
    """
